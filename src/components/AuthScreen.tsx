            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-theme-black-lighter border border-theme-gold/30 rounded-lg focus:ring-2 focus:ring-theme-gold focus:border-theme-gold outline-none text-theme-gold placeholder-theme-gold-dark/50"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-theme-gold bg-theme-black-lighter border-theme-gold/30 rounded-lg focus:ring-theme-gold focus:ring-2"
                  />
